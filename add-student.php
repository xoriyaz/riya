...
<html lang="en">
    ...
    <head>
        ...
        <title>College Lab Management system | Add Student</title>
...
<label for="studentname">Student Registation Number <span class="text-danger">*</span></label>
<input type="text" class="form-control" placeholder="Student Reg Number" required="true" name="studentregno">
</div>                          
<div class="form-group">
