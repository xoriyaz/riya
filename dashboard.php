...
<html lang="en">
        ...
        <!-- App title -->
        <title>College Lab Management system  || Dashboard</title>
...
?>
                           <i class="fa fa-desktop float-right"></i>
                            <h6 class="text-muted text-uppercase m-b-20">Number Of Desk Available</h6>
...
?>
                            <i class="fa fa-desktop float-right"></i>
                            <h6 class="text-muted text-uppercase m-b-20">Number of Desk Occupied</h6>
...
?>
                            ...
                            <h6 class="text-muted text-uppercase m-b-20">Total Number Of Students</h6>
