...
<html lang="en">
    ...
    <head>
        ...
        <title>College Lab Management System  || Login</title>
        ...
        <div class="wrapper-page">
        	...
        	<div class="account-bg">
                <div class="card-box mb-0">
                 ...
                 <h6>College Lab Management System </h6>
                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" action="" method="post">
                            ...
                            <div class="form-group row m-t-30 mb-0">
                                <div class="col-12">
                                    <a href="forgot-password.php" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot password !!</a>
                                </div>
                            </div>
